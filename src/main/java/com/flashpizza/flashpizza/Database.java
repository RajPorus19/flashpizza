...
public class Database {
	public String JDBCurl = "jdbc:mysql://localhost:3306/flashpizza?serverTimezone=UTC";
	public String sql = """
	...
	public void connect_db() {
		...
		try {
			Connection con = DriverManager.getConnection(this.JDBCurl,username,password);
			this.connection = con;
